...
class BWVSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class BWVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://publicadores/^^InstitucionDeportivaRepetidaException",BWVInstitucionDeportivaRepetidaException.class);
    } 
    ...
    public static void setDateTimeConverter(BWVDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new BWVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BWVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BWVDateTimeConverter dateTimeConverter = new BWVStandardDateTimeConverter();

    public BWVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BWVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BWVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BWVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BWVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BWVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
